...
export function SpeechInput({
  ...
  const [language, setLanguage] = useState<string>("hi-IN"); // Default language
  ...
  // Function to make AI speak (Text-to-Speech)
  ...
  const handleSpeechInput = async () => {
    ...
    recognition.onresult = async (event: SpeechRecognitionEvent) => {
      ...
      try {
        const result = await analyzeText(speechResult); // AI generates response
        setSolution(result);
        speakAIResponse(result); // AI speaks response
